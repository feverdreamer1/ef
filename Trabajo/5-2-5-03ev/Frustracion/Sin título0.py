...
def comparar_frustracion(directorio):
    ...
    # Anotación para darle un toque más pro
    plt.text(0.05, 0.9, 'Ruptura de la "Autopista Cuántica"', 
             transform=plt.gca().transAxes, fontsize=12, fontweight='bold', color='#d62728')
...
# EJECUCIÓN DIRECTA
# =========================================================
ruta = r"C:\Users\shara\Desktop\Electronica Fisica\Trabajo\5-2-5-03ev\Frustracion" # Cambia esto a tu carpeta con los 2 txt
